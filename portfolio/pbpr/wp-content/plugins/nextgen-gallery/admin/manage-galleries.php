...
function nggallery_manage_gallery_main() {
	...
	<div class="wrap">
		...
		<h2 style="color: red">DO NOT DELETE THE SHOWCASE GALLERY (Gallery 1)!!. go into it and delete the images and the text. If you delete the gallery if will destroy the order of the others!!!! You have been warned!!!</h2>
